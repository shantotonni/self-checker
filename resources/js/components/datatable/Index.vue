<template>
    <div class="datatable" v-if="!isLoading">
        ...
        <table id="datatable" class="table table-bordered table-striped dt-responsive nowrap dataTable no-footer dtr-inline table-sm small" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            <thead>
